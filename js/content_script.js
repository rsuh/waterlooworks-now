...
$(document).ready(function() {
  ...
  } else if ($("#dashboard_userCommonMyMessagesTableID").length) { // dashboard messages
    // messages aren't loaded right away, need to run after reload
    addReloadListener("#dashboard_userCommonMyMessagesTableID", replicateDashboardViewAction);
  }
});
